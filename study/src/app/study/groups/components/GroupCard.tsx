      ...
      <div className="p-4">
        ...
        <div className="mb-3">
          <div className="flex justify-between items-center mb-1">
            <span className="text-xs text-gray-600 font-medium">{group.members}/{group.capacity} joined</span>
        ...
        <button
          ...
          className={`w-full font-semibold py-2.5 rounded-lg text-sm transition-all duration-300 shadow-sm hover:shadow-md ${
            isJoined
